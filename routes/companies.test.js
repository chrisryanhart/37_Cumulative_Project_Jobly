...
// tests with u2AdminToken have admin status
...
describe("POST /companies", function () {
  ...
  test("Unauthorized admin blocked from adding company", async function () {
...
// anonymous users can still get companies
...
describe("GET /companies/:handle", function () {
  test("works for anon", async function () {
    ...
    expect(resp.body.company).toEqual(expect.objectContaining(
      {
        handle: "c1",
        name: "C1",
        description: "Desc1",
    ...
    expect(resp.body.company.jobs[0]).toEqual(expect.objectContaining(
        {
          title: "test job 1",
          salary: 50000,
          equity: "0.5"
...
// u2AdminToken user has admin access
